...
def tag(line):
    brand_pattern = line[1]
    # brand_pattern = "爸爸"
    # type_pattern = line[j]
    quote = line[0]
    # quote = line
    if re.search(brand_pattern, quote):
        # print("match:", brand_pattern, quote)
        ...
        total_list = label(total_list, span1, 'Disease') # B: Brand
